...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiaXN0ZXZrb3Zza2kiLCJhIjoiY2p4YmtzOHdiMDBlejNvcDl6azdzZHp6cSJ9.diH4AvcHrVz6noahp5RdLw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/istevkovski/ck1mwn2z305p51coe930i6qvx' // center: [-118.113491, 34.111745],
    // zoom: 10,
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add marker on map
  ...
  map.on('wheel', function (event) {
    if (event.originalEvent.ctrlKey || event.originalEvent.metaKey || event.originalEvent.altKey) return;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            urlType = type === 'password' ? 'update-password' : 'updateProfile';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
...
var stripe = Stripe('pk_test_azc0rPyzYAqDC1gaTyRjGl2R00M1TRO030');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn--save-password').textContent = 'Save password'; // Clear password fields after it has been updated
...
if (bookTourButton) bookTourButton.addEventListener('click', function (e) {
